...
public class QuestionUI extends JPanel {
    ...
    private void showNextQuestion() {
        ...
        // else if (questionCategory.equals("mathCategory")) questionCategory =
        // "Mathematics";
        // else if (questionCategory.equals("movieCategory")) questionCategory =
        // "Movies";
        // else if (questionCategory.equals("musicCategory")) questionCategory =
        // "Music";
        ...
        if (questionTextLabel.getText().length() >= 60)
            questionTextLabel.setFont(Constants.getRegularFont(17));
        else if (questionTextLabel.getText().length() >= 35)
            questionTextLabel.setFont(Constants.getRegularFont(18));
        else
            questionTextLabel.setFont(Constants.getRegularFont(20));
        ...
        if (currentQuestion.getQuestionAskType().equals("MCQ")) {
            ...
            for (String choice : questionChoices) {
                ...
                if (choice.length() >= 15)
                    btn.setFont(Constants.getRegularFont(13));
                else if (choice.length() >= 20)
                    btn.setFont(Constants.getRegularFont(9));
                else
                    btn.setFont(Constants.getRegularFont(16));
                ...
                public void keyPressed(KeyEvent e) {
                    ...
                    if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                        ...
                        if (fbqQuestion.validateUserAnswer(Arrays.asList(fillBlankInput.getText()))) {
                            ...
                            if (fbqQuestion.getCorrectAnswer().get(0).length() >= 15)
                                fillBlankInput.setFont(Constants.getBoldFont(14));
                        }
